...
path = "C:\\Program Files\\Meadowlark Optics\\Blink OverDrive Plus\\SDK"
...
if not constructed_okay:
    ...
    for i in range(0, 1000):
        slm_lib.Write_overdrive_image(sdk, 1, ramp_0.ctypes.data_as(POINTER(c_ubyte)), 0, 0)
        sleep(0.025) # This is in seconds
        slm_lib.Write_overdrive_image(sdk, 1, ramp_1.ctypes.data_as(POINTER(c_ubyte)), 0, 0)
        sleep(0.025) # This is in seconds
